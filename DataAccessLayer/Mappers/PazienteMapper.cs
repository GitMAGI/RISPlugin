...
namespace DataAccessLayer.Mappers
{
    public class PazienteMapper
    {
        ...
        public static IDAL.VO.PazienteVO PaziMapper(DataRow row)
        {
            ...
            pazi.archivio = row["archivio"] != DBNull.Value ? (int)row["archivio"] : (int?)null;
            ...
            pazi.data_nascita = row["data_nascita"] != DBNull.Value ? row["data_nascita"].ToString() : null;
            ...
            pazi.data_documento = row["data_documento"] != DBNull.Value ? row["data_documento"].ToString() : null;
            ...
            pazi.curante = row["curante"] != DBNull.Value ? (int)row["curante"] : (int?)null;
            pazi.seriale = row["seriale"] != DBNull.Value ? (int)row["seriale"] : (int?)null;
            ...
            pazi.data_cert = row["data_cert"] != DBNull.Value ? row["data_cert"].ToString() : null;
            pazi.data_creazione = row["data_creazione"] != DBNull.Value ? row["data_creazione"].ToString() : null;
            pazi.Export = row["Export"] != DBNull.Value ? (bool)row["Export"] : (bool?)null;
            pazi.dovuto = row["dovuto"] != DBNull.Value ? (double)row["dovuto"] : (double?)null;
            pazi.speciale = row["speciale"] != DBNull.Value ? (bool)row["speciale"] : (bool?)null;
            pazi.dovuto_privato = row["dovuto_privato"] != DBNull.Value ? (double)row["dovuto_privato"] : (double?)null;
            pazi.dovuto_assicurato = row["dovuto_assicurato"] != DBNull.Value ? (double)row["dovuto_assicurato"] : (double?)null;
